 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return pt({...t,state:!0,attribute:!1})}function gt(t,e){const i={fan:e},s=t.entities[e];if(!s?.device_id)return i;const n=s.device_id,r=Object.entries(t.entities).filter(([,t])=>t.device_id===n&&void 0===t.disabled_by);for(const[t]of r)t!==e&&(t.startsWith("light.")&&t.endsWith("_light")?i.light=t:t.startsWith("select.")&&t.endsWith("_color")?i.color=t:t.startsWith("switch.")&&t.endsWith("_direction")?i.direction=t:t.startsWith("switch.")&&t.endsWith("_mute")?i.mute=t:t.startsWith("sensor.")&&t.endsWith("_timer")?i.timer=t:t.startsWith("button.")&&t.endsWith("_cooldown_1h")?i.cooldown1h=t:t.startsWith("button.")&&t.endsWith("_cooldown_2h")?i.cooldown2h=t:t.startsWith("button.")&&t.endsWith("_cooldown_4h")&&(i.cooldown4h=t));return i}function mt(t,e){return t.states[e]?.state}function ft(t,e){const i=mt(t,e);return"on"===i||"ON"===i}function _t(t,e){return t.states[e]?.attributes?.preset_mode}function vt(t,e){const i=mt(t,e);if(i)try{const t=JSON.parse(i);return{duration:t.duration??0,remaining:t.remaining??0}}catch{return}}function bt(t,e){t.callService("fan","toggle",{entity_id:e})}function $t(t,e){t.callService("light","toggle",{entity_id:e})}function yt(t,e){const i=e.split(".")[0];t.callService(i,"toggle",{entity_id:e})}const wt=o`
  :host {
    --mush-spacing: 12px;
...
`;let At=class extends at{constructor(){super(...arguments),this.active=!1,this.icon="mdi:fan",this.label=""}static get styles(){return[wt,xt,o`
      ...
      `]}_handleClick(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("toggle-click",{bubbles:!0,composed:!0,detail:{active:this.active}}))}render(){return F`
      <button
    ...
    `}};t([pt({type:Boolean})],At.prototype,"active",void 0),t([pt({type:String})],At.prototype,"icon",void 0),t([pt({type:String})],At.prototype,"label",void 0),At=t([ct("create-fan-toggle")],At);let St=class extends at{constructor(){super(...arguments),this.speed=0}static get styles(){return[wt,o`
      ...
      `]}render(){return F`
      ${[1,2,3,4,5,6].map(t=>F`<div class="dot ${t<=this.speed?"active":""}"></div>`)}
    `}};t([pt({type:Number})],St.prototype,"speed",void 0),St=t([ct("create-fan-speed-dots")],St);let Et=class extends at{constructor(){super(...arguments),this.duration=0,this.remaining=0}static get styles(){return[wt,o`
      ...
      `]}_formatTime(t){if(t<=0)return"0m";const e=Math.floor(t/60),i=t%60;return e>0&&i>0?`${e}h ${i}m`:e>0?`${e}h`:`${i}m`}render(){return 0===this.duration||this.remaining<=0?F``:F`
    ...
    `}};t([pt({attribute:!1})],Ct.prototype,"hass",void 0),t([pt({type:String})],Ct.prototype,"entityId",void 0),t([pt({type:String})],Ct.prototype,"name",void 0),t([pt({attribute:!1})],Ct.prototype,"entities",void 0),Ct=t([ct("create-fan-compact-card")],Ct);let kt=class extends at{static get styles(){return[wt,o`
      ...
      <!-- Section 7: Timers -->
      ${this._hasCooldowns()?F`
            <div class="section">
              <div class="section-label">Timer</div>
              <div class="timer-row">
                ${this.entities.cooldown1h?F`
                      <button
                        class="timer-btn"
                ...
                ${this.entities.cooldown4h?F`
                    ...
                    `:""}
                ${this._getTimerData()?.remaining?F`
                      <create-fan-timer-display
