      ...
      ${this.entities.color?q`
            <div class="section">
              ...
              <div class="pill-group">
                <button
                  class="pill ${"cold"===this._getSelectedColor()?"active":""}"
                ...
                <button
                  class="pill ${"warm"===this._getSelectedColor()?"active":""}"
    ...
    `}};t([pt({attribute:!1})],Rt.prototype,"hass",void 0),t([pt({type:String})],Rt.prototype,"name",void 0),t([pt({attribute:!1})],Rt.prototype,"fanEntitiesList",void 0),Rt=t([ct("create-fan-group-compact-card")],Rt);let Ht=class extends at{static get styles(){return[St,r`
      ...
      ${t.hasColor?q`
            <div class="section">
              ...
              <div class="pill-group">
                <button
                  class="pill ${"cold"===t.color?"active":""}"
                  @click=${()=>this._handleColorSelect("cold")}
                >
                  Cold
                </button>
                ...
                <button
                  class="pill ${"warm"===t.color?"active":""}"
                  @click=${()=>this._handleColorSelect("warm")}
                >
                  Warm
                </button>
