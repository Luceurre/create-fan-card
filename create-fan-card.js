 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return pt({...t,state:!0,attribute:!1})}function gt(t,e){const i={fan:e},s=e.indexOf(".");if(-1===s)return i;const n=e.substring(s+1),r={light:`light.${n}_light`,color:`select.${n}_color`,direction:`switch.${n}_direction`,mute:`switch.${n}_mute`,timer:`sensor.${n}_timer`,cooldown1h:`button.${n}_cooldown_1h`,cooldown2h:`button.${n}_cooldown_2h`,cooldown4h:`button.${n}_cooldown_4h`};console.log("[create-fan-card] discoverFanEntities:",{fanEntityId:e,base:n,candidates:r});for(const[e,s]of Object.entries(r)){const n=!!t.states[s];console.log(`[create-fan-card]   ${e}: ${s} → ${n?"FOUND":"NOT FOUND"}`),n&&(i[e]=s)}return console.log("[create-fan-card] result:",i),i}function mt(t,e){return t.states[e]?.state}function ft(t,e){const i=mt(t,e);return"on"===i||"ON"===i}function vt(t,e){return t.states[e]?.attributes?.preset_mode}function _t(t,e){const i=mt(t,e);if(i)try{const t=JSON.parse(i);return{duration:t.duration??0,remaining:t.remaining??0}}catch{return}}function bt(t,e){t.callService("fan","toggle",{entity_id:e})}function $t(t,e){t.callService("light","toggle",{entity_id:e})}function yt(t,e){const i=e.split(".")[0];t.callService(i,"toggle",{entity_id:e})}const wt=o`
  :host {
    --mush-spacing: 12px;
...
`;let At=class extends at{constructor(){super(...arguments),this.active=!1,this.icon="mdi:fan",this.label=""}static get styles(){return[wt,xt,o`
    ...
    `}};t([pt({attribute:!1})],Ct.prototype,"hass",void 0),t([pt({type:String})],Ct.prototype,"entityId",void 0),t([pt({type:String})],Ct.prototype,"name",void 0),t([pt({attribute:!1})],Ct.prototype,"entities",void 0),Ct=t([ct("create-fan-compact-card")],Ct);let kt=class extends at{static get styles(){return[wt,o`
      ...
      `]}_isFanOn(){return!(!this.hass||!this.entities?.fan)&&ft(this.hass,this.entities.fan)}_getCurrentSpeed(){if(this.hass&&this.entities?.fan)return vt(this.hass,this.entities.fan)}_getSelectedColor(){if(this.hass&&this.entities?.color)return this.hass.states[this.entities.color]?.state}_isDirectionClockwise(){return!this.hass||!this.entities?.direction||ft(this.hass,this.entities.direction)}_isMuteOn(){return!(!this.hass||!this.entities?.mute)&&ft(this.hass,this.entities.mute)}_getTimerData(){if(this.hass&&this.entities?.timer)return _t(this.hass,this.entities.timer)}_handlePowerClick(){this.hass&&this.entities?.fan&&bt(this.hass,this.entities.fan)}_handleSpeedClick(t){if(!this.hass||!this.entities?.fan)return;const e=!this._isFanOn(),i=`speed${t}`;var s,n;!function(t,e,i){t.callService("fan","set_preset_mode",{entity_id:e,preset_mode:i})}(this.hass,this.entities.fan,i),e&&(s=this.hass,n=this.entities.fan,s.callService("fan","turn_on",{entity_id:n}))}_handleLightToggle(){this.hass&&this.entities?.light&&$t(this.hass,this.entities.light)}_handleColorSelect(t){this.hass&&this.entities?.color&&function(t,e,i){t.callService("select","select_option",{entity_id:e,option:i})}(this.hass,this.entities.color,t)}_handleDirectionToggle(){this.hass&&this.entities?.direction&&yt(this.hass,this.entities.direction)}_handleMuteToggle(){this.hass&&this.entities?.mute&&yt(this.hass,this.entities.mute)}_handleTimerPress(t){this.hass&&function(t,e){t.callService("button","press",{entity_id:e})}(this.hass,t)}_hasCooldowns(){return!!(this.entities?.cooldown1h||this.entities?.cooldown2h||this.entities?.cooldown4h)}render(){if(!this.hass||!this.entities)return B``;const t=this._isFanOn(),e=this._getCurrentSpeed();return B`
      <!-- Section 1: Fan Power -->
      <div class="section">
  ...
  `,t([ut()],Tt.prototype,"_config",void 0),t([ut()],Tt.prototype,"_entities",void 0),Tt=t([ct("create-fan-card")],Tt);const Ut=window;Ut.customCards=Ut.customCards||[];const Mt=Ut.customCards;Mt.some(t=>"create-fan-card"===t.type)||Mt.push({type:"create-fan-card",name:"Create Fan Card",description:"A Mushroom-styled card for controlling Create Ikohs ceiling fans"});export{Tt as CreateFanCard,Pt as CreateFanRemotePopupCard};
