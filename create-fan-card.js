 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return pt({...t,state:!0,attribute:!1})}function gt(t,e){const i={fan:e},s=e.indexOf(".");if(-1===s)return i;const n=e.substring(s+1),r={light:`light.${n}_light`,color:`select.${n}_color`,direction:`switch.${n}_direction`,mute:`switch.${n}_mute`,timer:`sensor.${n}_timer`,cooldown1h:`button.${n}_cooldown_1h`,cooldown2h:`button.${n}_cooldown_2h`,cooldown4h:`button.${n}_cooldown_4h`};console.log("[create-fan-card] discoverFanEntities:",{fanEntityId:e,base:n,candidates:r});for(const[e,s]of Object.entries(r)){const n=!!t.states[s];console.log(`[create-fan-card]   ${e}: ${s} → ${n?"FOUND":"NOT FOUND"}`),n&&(i[e]=s)}return console.log("[create-fan-card] result:",i),i}function mt(t,e){return t.states[e]?.state}function ft(t,e){const i=mt(t,e);return"on"===i||"ON"===i}function _t(t,e){return t.states[e]?.attributes?.preset_mode}function vt(t,e){const i=mt(t,e);if(i)try{const t=JSON.parse(i);return{duration:t.duration??0,remaining:t.remaining??0}}catch{return}}function bt(t,e){t.callService("fan","toggle",{entity_id:e})}function $t(t,e){t.callService("light","toggle",{entity_id:e})}function yt(t,e){const i=e.split(".")[0];t.callService(i,"toggle",{entity_id:e})}const wt=o`
  :host {
    --mush-spacing: 12px;
