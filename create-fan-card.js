 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return pt({...t,state:!0,attribute:!1})}function gt(t,e){const i={fan:e},s=e.indexOf(".");if(-1===s)return i;const n=e.substring(s+1),o={light:`light.${n}_light`,color:`select.${n}_color`,direction:`switch.${n}_direction`,mute:`switch.${n}_mute`,timer:`sensor.${n}_timer`,cooldown1h:`button.${n}_cooldown_1h`,cooldown2h:`button.${n}_cooldown_2h`,cooldown4h:`button.${n}_cooldown_4h`};for(const[e,s]of Object.entries(o))t.states[s]&&(i[e]=s);return i}function ft(t,e){return t.states[e]?.state}function mt(t,e){const i=ft(t,e);return"on"===i||"ON"===i}function vt(t,e){return t.states[e]?.attributes?.preset_mode}function bt(t,e){const i=ft(t,e);if(i)try{const t=JSON.parse(i);return{duration:t.duration??0,remaining:t.remaining??0}}catch{return}}function _t(t,e){t.callService("fan","toggle",{entity_id:e})}function $t(t,e,i){t.callService("fan","set_preset_mode",{entity_id:e,preset_mode:i})}function yt(t,e){t.callService("fan","turn_on",{entity_id:e})}function wt(t,e){t.callService("fan","turn_off",{entity_id:e})}function xt(t,e){t.callService("light","toggle",{entity_id:e})}function Et(t,e,i){t.callService("select","select_option",{entity_id:e,option:i})}function St(t,e){const i=e.split(".")[0];t.callService(i,"toggle",{entity_id:e})}function At(t,e){t.callService("button","press",{entity_id:e})}const Ct=r`
  :host {
    --mush-spacing: 12px;
...
`;let Ot=class extends at{constructor(){super(...arguments),this.active=!1,this.icon="mdi:fan",this.label=""}static get styles(){return[Ct,kt,r`
        :host {
    ...
    `}};t([pt({type:Boolean})],Ot.prototype,"active",void 0),t([pt({type:String})],Ot.prototype,"icon",void 0),t([pt({type:String})],Ot.prototype,"label",void 0),Ot=t([lt("create-fan-toggle")],Ot);let Tt=class extends at{constructor(){super(...arguments),this.speed=0}static get styles(){return[Ct,r`
        :host {
          display: inline-flex;
          align-items: center;
          gap: 3px;
    ...
    `}};t([pt({type:Number})],Tt.prototype,"speed",void 0),Tt=t([lt("create-fan-speed-dots")],Tt);let Lt=class extends at{constructor(){super(...arguments),this.duration=0,this.remaining=0}static get styles(){return[Ct,r`
        :host {
          display: inline-flex;
          align-items: center;
          gap: 4px;
    ...
    `}};t([pt({type:Number})],Lt.prototype,"duration",void 0),t([pt({type:Number})],Lt.prototype,"remaining",void 0),Lt=t([lt("create-fan-timer-display")],Lt);let Pt=class extends at{constructor(){super(...arguments),this.entityId="",this.name=""}static get styles(){return[Ct,kt,r`
        @keyframes spin {
          to {
    ...
    `}};t([pt({attribute:!1})],Pt.prototype,"hass",void 0),t([pt({type:String})],Pt.prototype,"entityId",void 0),t([pt({type:String})],Pt.prototype,"name",void 0),t([pt({attribute:!1})],Pt.prototype,"entities",void 0),Pt=t([lt("create-fan-compact-card")],Pt);let Mt=class extends at{static get styles(){return[Ct,r`
        :host {
          display: block;
          padding: 8px 0;
        }
      ...
      ${this._hasCooldowns()?q`
          ...
          `:""}
    `}};function zt(t){if(!t)return 0;const e=t.match(/(\d+)/);return e?parseInt(e[1],10):0}function Ut(t,e){if(0===e.length)return{fanOn:!1,speed:0,speedPreset:"",speedLabel:"Off",lightOn:!1,hasLight:!1,hasColor:!1,directionClockwise:!0,hasDirection:!1,muteOn:!1,hasMute:!1,hasTimer:!1,hasCooldowns:!1,hasCooldown1h:!1,hasCooldown2h:!1,hasCooldown4h:!1};const i=e.every(e=>mt(t,e.fan)),s=e.map(e=>vt(t,e.fan)),n=s.map(zt),o=n.length>0&&n.every(t=>t===n[0]),r=i&&o?n[0]:0,a=i&&o?s[0]??"":"",h=i?o?`Speed ${r}`:"Mixed":"Off",l=e.filter(t=>null!=t.light),c=l.length>0,d=c&&l.every(e=>mt(t,e.light)),p=e.filter(t=>null!=t.color),u=p.length>0;let g;if(u){const e=p.map(e=>ft(t,e.color)),i=e.length>0&&e.every(t=>t===e[0]);g=i?e[0]:void 0}const f=e.filter(t=>null!=t.direction),m=f.length>0;let v=!0;if(m){const e=f.map(e=>mt(t,e.direction)),i=e.every(t=>t===e[0]);v=!i||e[0]}const b=e.filter(t=>null!=t.mute),_=b.length>0,$=_&&b.every(e=>mt(t,e.mute));let y;for(const i of e)if(i.timer){const e=bt(t,i.timer);if(e){y=e;break}}const w=e.some(t=>null!=t.timer),x=e.some(t=>null!=t.cooldown1h),E=e.some(t=>null!=t.cooldown2h),S=e.some(t=>null!=t.cooldown4h);return{fanOn:i,speed:r,speedPreset:a,speedLabel:h,lightOn:d,hasLight:c,color:g,hasColor:u,directionClockwise:v,hasDirection:m,muteOn:$,hasMute:_,timerData:y,hasTimer:w,hasCooldowns:x||E||S,hasCooldown1h:x,hasCooldown2h:E,hasCooldown4h:S}}function Dt(t,e){const i=e.length>0&&e.every(e=>mt(t,e.fan));for(const s of e)i?wt(t,s.fan):yt(t,s.fan)}function Nt(t,e){for(const i of e)i.light&&xt(t,i.light)}t([pt({attribute:!1})],Mt.prototype,"hass",void 0),t([pt({attribute:!1})],Mt.prototype,"entities",void 0),Mt=t([lt("create-fan-remote-popup")],Mt);let Rt=class extends at{constructor(){super(...arguments),this.name=""}static get styles(){return[Ct,kt,r`
        @keyframes spin {
          to {
            transform: rotate(360deg);
          }
    ...
    `}};t([pt({attribute:!1})],Rt.prototype,"hass",void 0),t([pt({type:String})],Rt.prototype,"name",void 0),t([pt({attribute:!1})],Rt.prototype,"fanEntitiesList",void 0),Rt=t([lt("create-fan-group-compact-card")],Rt);let Ht=class extends at{static get styles(){return[Ct,r`
        :host {
          display: block;
          padding: 8px 0;
        }
  ...
  `,t([ut()],It.prototype,"_config",void 0),t([ut()],It.prototype,"_fanEntitiesList",void 0),It=t([lt("create-fan-group-remote-popup-card")],It);let jt=class extends at{static getStubConfig(){return{entities:[]}}set hass(t){const e=this._hass;this._hass=t,t&&this._config&&(this._fanEntitiesList=this._resolveEntities(t,this._config)),this.requestUpdate("hass",e)}get hass(){return this._hass}setConfig(t){if(!t.entities||!Array.isArray(t.entities)||0===t.entities.length)throw new Error("entities must be a non-empty array of fan entity IDs");this._config=t,this._fanEntitiesList=this._hass?this._resolveEntities(this._hass,t):void 0}getCardSize(){return 3}_resolveEntities(t,e){return e.entities.map(e=>gt(t,e))}_getTitle(){return this._config?this._config.name??"Fan Group":"Fan Group"}_handleOpenRemote(t){const e=t.detail.fanEntitiesList[0]?.fan;Ft(this,{title:this._getTitle(),content:{type:"custom:create-fan-group-remote-popup-card",entity:e,fanEntitiesList:t.detail.fanEntitiesList}})}render(){return this._config&&this._hass?q`
