 ...
 */
const e=globalThis,i=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s=Symbol(),n=new WeakMap;let o=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==s)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(i&&void 0===t){const i=void 0!==e&&1===e.length;i&&(t=n.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&n.set(e,t))}return t}toString(){return this.cssText}};const r=(t,...e)=>{const i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new o(i,t,s)},a=i?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new o("string"==typeof t?t:t+"",void 0,s))(e)})(t):t,{is:h,defineProperty:c,getOwnPropertyDescriptor:l,getOwnPropertyNames:d,getOwnPropertySymbols:p,getPrototypeOf:u}=Object,g=globalThis,f=g.trustedTypes,m=f?f.emptyScript:"",b=g.reactiveElementPolyfillSupport,v=(t,e)=>t,_={toAttribute(t,e){switch(e){case Boolean:t=t?m:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},$=(t,e)=>!h(t,e),y={attribute:!0,type:String,converter:_,reflect:!1,useDefault:!1,hasChanged:$};
/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return pt({...t,state:!0,attribute:!1})}function gt(t,e){const i={fan:e},s=e.indexOf(".");if(-1===s)return i;const n=e.substring(s+1),o={light:`light.${n}_light`,color:`select.${n}_color`,direction:`switch.${n}_direction`,mute:`switch.${n}_mute`,timer:`sensor.${n}_timer`,cooldown1h:`button.${n}_cooldown_1h`,cooldown2h:`button.${n}_cooldown_2h`,cooldown4h:`button.${n}_cooldown_4h`};for(const[e,s]of Object.entries(o))t.states[s]&&(i[e]=s);return i}function ft(t,e){return t.states[e]?.state}function mt(t,e){const i=ft(t,e);return"on"===i||"ON"===i}function bt(t,e){return t.states[e]?.attributes?.preset_mode}function vt(t,e){const i=ft(t,e);if(i)try{const t=JSON.parse(i);return{duration:t.duration??0,remaining:t.remaining??0}}catch{return}}function _t(t,e){t.callService("fan","toggle",{entity_id:e})}function $t(t,e,i){t.callService("fan","set_preset_mode",{entity_id:e,preset_mode:i})}function yt(t,e){t.callService("fan","turn_on",{entity_id:e})}function wt(t,e){t.callService("fan","turn_off",{entity_id:e})}function xt(t,e){t.callService("light","toggle",{entity_id:e})}function Et(t,e,i){t.callService("select","select_option",{entity_id:e,option:i})}function St(t,e){const i=e.split(".")[0];t.callService(i,"toggle",{entity_id:e})}function Ct(t,e){t.callService("button","press",{entity_id:e})}const At=r`
  :host {
    --mush-spacing: 12px;
...
`;let Ot=class extends at{constructor(){super(...arguments),this.active=!1,this.icon="mdi:fan",this.label="",this.type="fan"}static get styles(){return[At,r`
        :host {
      ...
      `]}_handleClick(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("toggle-click",{bubbles:!0,composed:!0,detail:{active:this.active}}))}render(){return q`
      <button
    ...
    `}};t([pt({type:Boolean})],Ot.prototype,"active",void 0),t([pt({type:String})],Ot.prototype,"icon",void 0),t([pt({type:String})],Ot.prototype,"label",void 0),t([pt({type:String})],Ot.prototype,"type",void 0),Ot=t([ct("create-fan-toggle")],Ot);let Lt=class extends at{constructor(){super(...arguments),this.speed=0}static get styles(){return[At,r`
        :host {
          display: inline-flex;
          align-items: center;
          gap: 3px;
    ...
    `}};t([pt({type:Number})],Lt.prototype,"speed",void 0),Lt=t([ct("create-fan-speed-dots")],Lt);let Tt=class extends at{constructor(){super(...arguments),this.duration=0,this.remaining=0}static get styles(){return[At,r`
        :host {
          display: inline-flex;
          align-items: center;
          gap: 4px;
    ...
    `}};t([pt({type:Number})],Tt.prototype,"duration",void 0),t([pt({type:Number})],Tt.prototype,"remaining",void 0),Tt=t([ct("create-fan-timer-display")],Tt);let Pt=class extends at{constructor(){super(...arguments),this.entityId="",this.name=""}static get styles(){return[At,kt,r`
        @keyframes spin {
          to {
    ...
    `}};t([pt({attribute:!1})],Pt.prototype,"hass",void 0),t([pt({type:String})],Pt.prototype,"entityId",void 0),t([pt({type:String})],Pt.prototype,"name",void 0),t([pt({attribute:!1})],Pt.prototype,"entities",void 0),Pt=t([ct("create-fan-compact-card")],Pt);let Mt=class extends at{static get styles(){return[At,r`
        :host {
          display: block;
          padding: 8px 0;
        }
      ...
      `]}_isFanOn(){return!(!this.hass||!this.entities?.fan)&&mt(this.hass,this.entities.fan)}_getCurrentSpeed(){if(this.hass&&this.entities?.fan)return bt(this.hass,this.entities.fan)}_getSelectedColor(){if(this.hass&&this.entities?.color)return this.hass.states[this.entities.color]?.state}_isDirectionClockwise(){return!this.hass||!this.entities?.direction||mt(this.hass,this.entities.direction)}_isMuteOn(){return!(!this.hass||!this.entities?.mute)&&mt(this.hass,this.entities.mute)}_getTimerData(){if(this.hass&&this.entities?.timer)return vt(this.hass,this.entities.timer)}_handlePowerClick(){this.hass&&this.entities?.fan&&_t(this.hass,this.entities.fan)}_handleSpeedClick(t){if(!this.hass||!this.entities?.fan)return;const e=!this._isFanOn(),i=`speed${t}`;$t(this.hass,this.entities.fan,i),e&&yt(this.hass,this.entities.fan)}_handleLightToggle(){this.hass&&this.entities?.light&&xt(this.hass,this.entities.light)}_handleColorSelect(t){this.hass&&this.entities?.color&&Et(this.hass,this.entities.color,t)}_handleDirectionToggle(){this.hass&&this.entities?.direction&&St(this.hass,this.entities.direction)}_handleMuteToggle(){this.hass&&this.entities?.mute&&St(this.hass,this.entities.mute)}_handleTimerPress(t){this.hass&&Ct(this.hass,t)}_hasCooldowns(){return!!(this.entities?.cooldown1h||this.entities?.cooldown2h||this.entities?.cooldown4h)}render(){if(!this.hass||!this.entities)return q``;const t=this._isFanOn(),e=this._getCurrentSpeed();return q`
      <!-- Section 1: Fan Power -->
      <div class="section">
      ...
      ${this._hasCooldowns()?q`
          ...
          `:""}
    `}};function zt(t){if(!t)return 0;const e=t.match(/(\d+)/);return e?parseInt(e[1],10):0}function Ut(t,e){if(0===e.length)return{fanOn:!1,speed:0,speedPreset:"",speedLabel:"Off",lightOn:!1,hasLight:!1,hasColor:!1,directionClockwise:!0,hasDirection:!1,muteOn:!1,hasMute:!1,hasTimer:!1,hasCooldowns:!1,hasCooldown1h:!1,hasCooldown2h:!1,hasCooldown4h:!1};const i=e.every(e=>mt(t,e.fan)),s=e.map(e=>bt(t,e.fan)),n=s.map(zt),o=n.length>0&&n.every(t=>t===n[0]),r=i&&o?n[0]:0,a=i&&o?s[0]??"":"",h=i?o?`Speed ${r}`:"Mixed":"Off",c=e.filter(t=>null!=t.light),l=c.length>0,d=l&&c.every(e=>mt(t,e.light)),p=e.filter(t=>null!=t.color),u=p.length>0;let g;if(u){const e=p.map(e=>ft(t,e.color)),i=e.length>0&&e.every(t=>t===e[0]);g=i?e[0]:void 0}const f=e.filter(t=>null!=t.direction),m=f.length>0;let b=!0;if(m){const e=f.map(e=>mt(t,e.direction)),i=e.every(t=>t===e[0]);b=!i||e[0]}const v=e.filter(t=>null!=t.mute),_=v.length>0,$=_&&v.every(e=>mt(t,e.mute));let y;for(const i of e)if(i.timer){const e=vt(t,i.timer);if(e){y=e;break}}const w=e.some(t=>null!=t.timer),x=e.some(t=>null!=t.cooldown1h),E=e.some(t=>null!=t.cooldown2h),S=e.some(t=>null!=t.cooldown4h);return{fanOn:i,speed:r,speedPreset:a,speedLabel:h,lightOn:d,hasLight:l,color:g,hasColor:u,directionClockwise:b,hasDirection:m,muteOn:$,hasMute:_,timerData:y,hasTimer:w,hasCooldowns:x||E||S,hasCooldown1h:x,hasCooldown2h:E,hasCooldown4h:S}}function Dt(t,e){const i=e.length>0&&e.every(e=>mt(t,e.fan));for(const s of e)i?wt(t,s.fan):yt(t,s.fan)}function Nt(t,e){for(const i of e)i.light&&xt(t,i.light)}t([pt({attribute:!1})],Mt.prototype,"hass",void 0),t([pt({attribute:!1})],Mt.prototype,"entities",void 0),Mt=t([ct("create-fan-remote-popup")],Mt);let Rt=class extends at{constructor(){super(...arguments),this.name=""}static get styles(){return[At,kt,r`
        @keyframes spin {
          to {
            transform: rotate(360deg);
          }
      ...
      `]}_getGroupState(){return this.hass&&this.fanEntitiesList?.length?Ut(this.hass,this.fanEntitiesList):null}_onFanToggle(t){t.stopPropagation(),this.hass&&this.fanEntitiesList?.length&&Dt(this.hass,this.fanEntitiesList)}_onLightToggle(t){t.stopPropagation(),this.hass&&this.fanEntitiesList?.length&&Nt(this.hass,this.fanEntitiesList)}_onIconClick(t){t.stopPropagation(),this.hass&&this.fanEntitiesList?.length&&Dt(this.hass,this.fanEntitiesList)}_openRemote(){this.dispatchEvent(new CustomEvent("open-remote",{bubbles:!0,composed:!0,detail:{fanEntitiesList:this.fanEntitiesList}}))}render(){if(!this.hass||!this.fanEntitiesList?.length)return q``;const t=this._getGroupState();if(!t)return q``;const e=t.fanOn,i=t.speed,s=t.lightOn,n=t.hasLight,o=t.hasTimer,r=t.timerData,a=i>0?`Speed ${i}`:-1===i?"Mixed":"Off";return q`
      <ha-card>
        <div class="card-content" @click=${this._openRemote}>
          <div class="shape-icon ${e?"on":""}" @click=${this._onIconClick}>
            <ha-icon .icon=${"mdi:fan"}></ha-icon>
    ...
    `}};t([pt({attribute:!1})],Rt.prototype,"hass",void 0),t([pt({type:String})],Rt.prototype,"name",void 0),t([pt({attribute:!1})],Rt.prototype,"fanEntitiesList",void 0),Rt=t([ct("create-fan-group-compact-card")],Rt);let It=class extends at{static get styles(){return[At,r`
        :host {
          display: block;
          padding: 8px 0;
        }
      ...
      `]}_getGroupState(){return this.hass&&this.fanEntitiesList?.length?Ut(this.hass,this.fanEntitiesList):null}_handlePowerClick(){this.hass&&this.fanEntitiesList?.length&&Dt(this.hass,this.fanEntitiesList)}_handleSpeedClick(t){if(!this.hass||!this.fanEntitiesList?.length)return;const e=this._getGroupState(),i=e&&!e.fanOn;!function(t,e,i){for(const s of e)$t(t,s.fan,i)}(this.hass,this.fanEntitiesList,`speed${t}`),i&&function(t,e){for(const i of e)yt(t,i.fan)}(this.hass,this.fanEntitiesList)}_handleLightToggle(){this.hass&&this.fanEntitiesList?.length&&Nt(this.hass,this.fanEntitiesList)}_handleColorSelect(t){this.hass&&this.fanEntitiesList?.length&&function(t,e,i){for(const s of e)s.color&&Et(t,s.color,i)}(this.hass,this.fanEntitiesList,t)}_handleDirectionToggle(){this.hass&&this.fanEntitiesList?.length&&function(t,e){for(const i of e)i.direction&&St(t,i.direction)}(this.hass,this.fanEntitiesList)}_handleMuteToggle(){this.hass&&this.fanEntitiesList?.length&&function(t,e){for(const i of e)i.mute&&St(t,i.mute)}(this.hass,this.fanEntitiesList)}_handleTimerPress(){this.hass&&this.fanEntitiesList?.length&&function(t,e){for(const i of e){const e=i.cooldown1h??i.cooldown2h??i.cooldown4h;e&&Ct(t,e)}}(this.hass,this.fanEntitiesList)}_hasCooldowns(t){return t.hasCooldowns}render(){if(!this.hass||!this.fanEntitiesList?.length)return q``;const t=this._getGroupState();if(!t)return q``;const e=t.fanOn,i=t.speedPreset;return q`
      <div class="section">
        <div class="section-label">Power</div>
        <button
  ...
  `,t([ut()],Gt.prototype,"_config",void 0),t([ut()],Gt.prototype,"_entities",void 0),Gt=t([ct("create-fan-card")],Gt);const Vt=window;Vt.customCards=Vt.customCards||[];const Jt=Vt.customCards;Jt.some(t=>"create-fan-card"===t.type)||Jt.push({type:"create-fan-card",name:"Create Fan Card",description:"A Mushroom-styled card for controlling Create Ikohs ceiling fans"});export{Gt as CreateFanCard,Wt as CreateFanRemotePopupCard};
