 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return pt({...t,state:!0,attribute:!1})}function gt(t,e){const i={fan:e},s=e.indexOf(".");if(-1===s)return i;const n=e.substring(s+1),r={light:`light.${n}_light`,color:`select.${n}_color`,direction:`switch.${n}_direction`,mute:`switch.${n}_mute`,timer:`sensor.${n}_timer`,cooldown1h:`button.${n}_cooldown_1h`,cooldown2h:`button.${n}_cooldown_2h`,cooldown4h:`button.${n}_cooldown_4h`};console.log("[create-fan-card] discoverFanEntities:",{fanEntityId:e,base:n,candidates:r});for(const[e,s]of Object.entries(r)){const n=!!t.states[s];console.log(`[create-fan-card]   ${e}: ${s} → ${n?"FOUND":"NOT FOUND"}`),n&&(i[e]=s)}return console.log("[create-fan-card] result:",i),i}function ft(t,e){return t.states[e]?.state}function mt(t,e){const i=ft(t,e);return"on"===i||"ON"===i}function _t(t,e){return t.states[e]?.attributes?.preset_mode}function vt(t,e){const i=ft(t,e);if(i)try{const t=JSON.parse(i);return{duration:t.duration??0,remaining:t.remaining??0}}catch{return}}function bt(t,e){t.callService("fan","toggle",{entity_id:e})}function $t(t,e){t.callService("light","toggle",{entity_id:e})}function yt(t,e){const i=e.split(".")[0];t.callService(i,"toggle",{entity_id:e})}const wt=o`
  :host {
    --mush-spacing: 12px;
...
`;let At=class extends at{constructor(){super(...arguments),this.active=!1,this.icon="mdi:fan",this.label=""}static get styles(){return[wt,xt,o`
    ...
    `}};t([pt({attribute:!1})],Ct.prototype,"hass",void 0),t([pt({type:String})],Ct.prototype,"entityId",void 0),t([pt({type:String})],Ct.prototype,"name",void 0),t([pt({attribute:!1})],Ct.prototype,"entities",void 0),Ct=t([ct("create-fan-compact-card")],Ct);let kt=class extends at{static get styles(){return[wt,o`
      ...
      `]}_isFanOn(){return!(!this.hass||!this.entities?.fan)&&mt(this.hass,this.entities.fan)}_getCurrentSpeed(){if(this.hass&&this.entities?.fan)return _t(this.hass,this.entities.fan)}_getSelectedColor(){if(this.hass&&this.entities?.color)return this.hass.states[this.entities.color]?.state}_isDirectionClockwise(){return!this.hass||!this.entities?.direction||mt(this.hass,this.entities.direction)}_isMuteOn(){return!(!this.hass||!this.entities?.mute)&&mt(this.hass,this.entities.mute)}_getTimerData(){if(this.hass&&this.entities?.timer)return vt(this.hass,this.entities.timer)}_handlePowerClick(){this.hass&&this.entities?.fan&&bt(this.hass,this.entities.fan)}_handleSpeedClick(t){if(!this.hass||!this.entities?.fan)return;const e=!this._isFanOn(),i=`speed${t}`;var s,n;!function(t,e,i){t.callService("fan","set_preset_mode",{entity_id:e,preset_mode:i})}(this.hass,this.entities.fan,i),e&&(s=this.hass,n=this.entities.fan,s.callService("fan","turn_on",{entity_id:n}))}_handleLightToggle(){this.hass&&this.entities?.light&&$t(this.hass,this.entities.light)}_handleColorSelect(t){this.hass&&this.entities?.color&&function(t,e,i){t.callService("select","select_option",{entity_id:e,option:i})}(this.hass,this.entities.color,t)}_handleDirectionToggle(){this.hass&&this.entities?.direction&&yt(this.hass,this.entities.direction)}_handleMuteToggle(){this.hass&&this.entities?.mute&&yt(this.hass,this.entities.mute)}_handleTimerPress(t){this.hass&&function(t,e){t.callService("button","press",{entity_id:e})}(this.hass,t)}_hasCooldowns(){return!!(this.entities?.cooldown1h||this.entities?.cooldown2h||this.entities?.cooldown4h)}render(){if(!this.hass||!this.entities)return B``;const t=this._isFanOn(),e=this._getCurrentSpeed();return B`
      <!-- Section 1: Fan Power -->
      <div class="section">
  ...
  `,t([ut()],Pt.prototype,"_config",void 0),t([ut()],Pt.prototype,"_entities",void 0),Pt=t([ct("create-fan-remote-popup-card")],Pt);let Tt=class extends at{static getStubConfig(){return{entity:""}}set hass(t){const e=this._hass;this._hass=t,t&&this._config&&(this._entities=this._resolveEntities(t,this._config)),this.requestUpdate("hass",e)}get hass(){return this._hass}setConfig(t){if(!t.entity)throw new Error("entity is required");this._config=t,this._entities=this._hass?this._resolveEntities(this._hass,t):void 0}getCardSize(){return 3}_resolveEntities(t,e){const i=gt(t,e.entity);return e.light_entity?{...i,light:e.light_entity}:i}_getTitle(){return this._config?this._config.name??this._hass?.states[this._config.entity]?.attributes?.friendly_name??"Fan Remote":"Fan Remote"}_handleOpenRemote(t){!function(t,e){if(console.log("[create-fan-card] openPopup called",{browserModAvailable:Ot(),config:e}),Ot()){const t={browser_mod:{service:"browser_mod.popup",data:{title:e.title,content:e.content}}};console.log("[create-fan-card] dispatching ll-custom on document.body",JSON.stringify(t));const i=new CustomEvent("ll-custom",{bubbles:!0,composed:!0,detail:t});document.body.dispatchEvent(i)}else{console.log("[create-fan-card] browser_mod not available, falling back to more-info");const i=e.content.entity;if(i){const e=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:i}});t.dispatchEvent(e)}}}(this,{title:this._getTitle(),content:{type:"custom:create-fan-remote-popup-card",entity:t.detail.entityId,entities:t.detail.entities}})}render(){return this._config&&this._hass?B`
